    ...
    <div id="book-list">
        <div class="field-wrap">
            <div class="pro-search">
                <dl class="field-list">
                    <dt>题&nbsp;&nbsp;材:</dt>
                    <dd><a class="active1" href="${pageContext.request.contextPath}/protfolio">全部</a></dd>
                    <dd><a href="${pageContext.request.contextPath}/protfolio1?comiclistid=1">总裁</a></dd>
                    <dd><a href="${pageContext.request.contextPath}/protfolio1?comiclistid=2">玄幻</a></dd>
                    <dd><a href="${pageContext.request.contextPath}/protfolio1?comiclistid=3">都市</a></dd>
                    <dd><a href="${pageContext.request.contextPath}/protfolio1?comiclistid=4">冒险</a></dd>
                    <dd><a href="${pageContext.request.contextPath}/protfolio1?comiclistid=5">仙侠</a></dd>
                    <dd><a href="${pageContext.request.contextPath}/protfolio1?comiclistid=6">热血</a></dd>
                    <dd><a href="${pageContext.request.contextPath}/protfolio1?comiclistid=7">恋爱</a></dd>
                    <dd><a href="${pageContext.request.contextPath}/protfolio1?comiclistid=8">校园</a></dd>
                    <dd><a href="${pageContext.request.contextPath}/protfolio1?comiclistid=9">武侠</a></dd>
                    <dd><a href="${pageContext.request.contextPath}/protfolio1?comiclistid=10">悬疑</a></dd>
                    <dd><a href="${pageContext.request.contextPath}/protfolio1?comiclistid=11">推理</a></dd>
                    <dd><a href="${pageContext.request.contextPath}/protfolio1?comiclistid=12">治愈</a></dd>
                    <dd><a href="${pageContext.request.contextPath}/protfolio1?comiclistid=13">穿越</a></dd>
                    <dd><a href="${pageContext.request.contextPath}/protfolio1?comiclistid=14">搞笑</a></dd>
                    <dd><a href="${pageContext.request.contextPath}/protfolio1?comiclistid=15">古风</a></dd>
                    <dd><a href="${pageContext.request.contextPath}/protfolio1?comiclistid=16">后宫</a></dd>
            ...
            <div class="pro-search">
                <dl class="field-list">
                    <dt>地&nbsp;&nbsp;区:</dt>
                    <dd><a class="active1" href="${pageContext.request.contextPath}/protfolio">全部</a></dd>
                    <dd><a href="${pageContext.request.contextPath}/protfolio?area=国漫">国漫</a></dd>
                    <dd><a href="${pageContext.request.contextPath}/protfolio?area=日漫">日漫</a></dd>
                    <dd><a href="${pageContext.request.contextPath}/protfolio?area=欧美">欧美</a></dd>
                </dl></div>
            <br />
            <div class="pro-search">
                <dl class="field-list">
                    <dt>进&nbsp;&nbsp;度:</dt>
                    <dd><a class="active1" href="${pageContext.request.contextPath}/protfolio">全部</a></dd>
                    <dd><a href="${pageContext.request.contextPath}/protfolio?ccode=连载">连载</a></dd>
                    <dd><a href="${pageContext.request.contextPath}/protfolio?ccode=完结">完结</a></dd>
                </dl></div><br />
        </div>
    </div>
